...
*** Dotfiles and Repositories
    ...
    machines without boxen. I used to use both [[https://github.com/andsens/homeshick][homeshick]] and boxen,
    but have since switched to only boxen.
...
**** Screen Saver
     ...
     I've started using [[https://github.com/JohnCoates/Aerial][Aerial]]. Boxen will install it, but you still
     need to open System Preferences -> Desktop & Screen Saver ->
     Screen Saver, and select it.
