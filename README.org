...
**** VirtualBox and Vagrant
     ...
     So far, when I've been using virtual machines, I've been using
     these two pieces of software together. I grabbed the latest of
     each version as of January, 2015.
